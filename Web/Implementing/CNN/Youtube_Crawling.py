...
# 20190909 v.2.0.0 결과값을 return할 수 있도록 수정      김한동
# 20190915 v.2.0.1 필요 없는 부분 주석 처리              김한동
# =============================
# description
...
def main(url):
    ...
    lstReturn.append(video.title)
    lstReturn.append(video.rating)
    lstReturn.append(video.duration)
    lstReturn.append(thumbnail)
